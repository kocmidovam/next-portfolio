"use client"
import { useTransition, useState, ReactElement } from "react"
      ...
      <div className='md:grid md:grid-cols-2 gap-14 pb-8 pt-8 md:pt-24 xl:gap-16 sm:pb-16 xl:px-16'>
        ...
        <div className='mt-4 md:mt-0 text-left flex flex-col h-full'>
          ...
          <p className='text-[#dbe2f8] lg:text-lg'>
            I'm Marta, a Medior Frontend Developer building web applications with React, Next.js,
            and TypeScript. I create responsive, interactive interfaces and enjoy working on
            projects where I can contribute meaningfully while continuing to learn and grow.
          </p>
          <br></br>
          <p className='text-[#dbe2f8] lg:text-lg'>
            I have hands-on experience with modern frontend workflows, from component design to API
            integration, and I'm always looking for opportunities to refine my craft.
          </p>
          ...
          <div className='mt-8'>{TAB_DATA?.find((t: Tab) => t.id === tab)?.content}</div>
        </div>
      </div>
    </section>
  )
