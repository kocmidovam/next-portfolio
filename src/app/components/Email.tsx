                    ...
                    <form className="flex flex-col" onSubmit={handleSubmit}>
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                placeholder="kocmidova.marta@seznam.cz"
                            />
                        </div>
                        <div className="mb-6">
                            <label
                        ...
                        <button
                            type="submit"
                            className="text-white font-medium py-2.5 px-5 rounded-lg w-full bg-gradient-to-r from-primary-900 to-secondary-400 hover:bg-primary-600"
                        >
                            Send Message
                        </button>
                    </form>
